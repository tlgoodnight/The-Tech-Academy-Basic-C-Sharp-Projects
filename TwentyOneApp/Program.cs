...
namespace TwentyOneApp
{
    class Program
    {
        ...
        {
            const string casinoName = "Goodnight Hotel and Casino";
            Console.WriteLine("Welcome to the {0}. Please tell us your name:", casinoName);
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                while (player.isActivelyPlaying && player.Balance > 0 )
                {
                    ...
                    {
                        Console.WriteLine("An error has occured. Contact your administrator.");
                        UpdateDbWithException(ex);
                        Console.ReadLine();
                        return;
                    }
