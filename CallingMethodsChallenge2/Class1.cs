...
namespace CallingMethodsChallenge
{
    ...
    {
        public int Method1(int result1)//the first method as an integer.
        {
            //equation is how many hours a year the person sleeps.
            return result1 * 365;
        }
        
        public decimal Method1(decimal result2)//second method as decimal
        {
        ...
        public string Method1(string result3)
        {
